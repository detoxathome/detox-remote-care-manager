 ...
 * actions for synchronisation with a remote database. You can configure logging
 * before calling {@link #initDatabase(String, List, boolean) initDatabase()} or
 * {@link #getDatabase(String) getDatabase()}. For more information see {@link
 * Database Database}.</p>
 * 
...
public abstract class DatabaseConnection {
	...
	public Database initDatabase(String name,
		...
		if (cache.containsDatabase(name))
