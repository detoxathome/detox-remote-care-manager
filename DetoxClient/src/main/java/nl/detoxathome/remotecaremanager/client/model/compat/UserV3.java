 ...
 */
public class UserV3 extends BaseDatabaseObject {
	@JsonIgnore
	private String id;
	...
	/**
	 * Converts a User object to a UserV3 object.
	 *
	 * @param user the User object
	 * @return the UserV3 object
	 */
	public static UserV3 fromUser(User user) {
		UserV3 result = new UserV3();
