...
import nl.detoxathome.remotecaremanager.client.model.compat.LinkedSensorV0;
import nl.detoxathome.remotecaremanager.client.model.compat.LinkedSensorV0Table;
...
public class LinkedSensor extends UTCSample {
	 ...
	 * server
	 */
	public static LinkedSensor findLinkedSensor(DetoxClient client,
			BaseProject project, String user, LocalDate date,
			String... products) throws DetoxClientException,
	...
	public static LinkedSensor findLinkedSensorWithClass(DetoxClient client,
			BaseProject project, String user, LocalDate date, Class<?> clazz)
