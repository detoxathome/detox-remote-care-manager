...
import nl.detoxathome.remotecaremanager.dao.sync.SyncProgress;
import nl.rrd.utils.json.JsonObject;

/**
 * The result of {@link
 * DetoxClient#syncWrite(String, int, Database, String, SyncRestriction, SyncProgressListener)
 * syncWrite()} or {@link
 * DetoxClient#syncRead(String, int, Database, String, boolean, SyncRestriction, SyncProgressListener)
