 ...
 */
public class UserV1 extends BaseDatabaseObject {
	@JsonIgnore
	private String id;
	...
	/**
	 * Converts a User object to a UserV1 object.
	 * 
	 * @param user the User object
	 * @return the UserV1 object
	 */
	public static UserV1 fromUser(User user) {
