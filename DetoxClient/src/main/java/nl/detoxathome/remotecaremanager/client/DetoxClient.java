...
/**
 * The Detox client can communicate with the Detox web service. After
 ...
 * DetoxClientException DetoxClientException}. General error codes that
 * may occur:</p>
 * 
 * <p><ul>
...
public class DetoxClient {
	...
	/**
	 * Constructs a new Detox client.
	 * 
	 * @param baseUrl the base URL of the Detox service, e.g.
	 * https://www.example.com/servlets/detoxrcm. Any trailing slashes are
	 * discarded.
	 */
	public DetoxClient(String baseUrl) {
	...
	/**
	 * Logs in to Detox. The returned token will expire after {@link
	...
	public LoginResult login(String email, String password)
			throws DetoxClientException, HttpClientException, ParseException,
			IOException {
	...
	/**
	 * Logs in to Detox. The service may return the following error codes:
	 * 
	 * <p><ul>
	 * <li>{@link ErrorCode#INVALID_CREDENTIALS INVALID_CREDENTIALS}:
	 * If the email or password is invalid.</li>
	...
	/**
	 * Logs in to Detox with a username. This can be the email address or
	 ...
	 * server
	 */
	public TokenResult loginAs(final String user) throws DetoxClientException,
	...
	public TokenResult signup(String email, String password,
			Integer tokenExpiration, boolean cookie, boolean autoExtendCookie,
			String project) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
	...
	/**
	 * Creates a new temporary Detox user. The user will have role "patient"
	 * and will be added to the specified project. This endpoint creates a user
	 * with a random email address in domain "temp.detoxrcm.local" and a random
	...
	public void changePassword(String email, String oldPassword,
			String newPassword) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
		Map<String,String> postParams = new LinkedHashMap<>();
		if (email != null)
	 ...
	 * 
	 * <p>You may specify a locale so Detox tries to send the email in the
	...
	public void resetPassword(final String email, final String code,
			final String password) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		Map<String,String> postParams = new LinkedHashMap<>();
		postParams.put("email", email);
		postParams.put("code", code);
	 ...
	 * server
	 */
	public MfaRecord addMfaRecordTotp() throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public VerifyAddMfaRecordResult verifyAddMfaRecord(String mfaId,
			String code) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
	 ...
	 * server
	 */
	public void deleteMfaRecord(String mfaId) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 * server
	 */
	public List<MfaRecord> getMfaRecords() throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 * server
	 */
	public List<ListUser> getUserList() throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 * server
	 */
	public User getUser(final String user) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 * server
	 */
	public User getUserByEmail(final String email) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		return runQuery("/user/", "GET", true,
				client -> {
					if (email != null)
	 ...
	 */
	public User updateUser(final String user, final Map<String,?> userData,
			String emailTemplate) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		return runQuery("/user/", "PUT", true,
				client -> {
					if (user != null)
	 ...
	 * server
	 */
	public void deleteUser(final String user) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public Group getGroup(final String name,
			final boolean includeInactiveMembers) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 * server
	 */
	public void deleteGroup(final String name) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 * server
	 */
	public List<Project> getProjectList() throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 * server
	 */
	public List<String> getAllProjectList() throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public List<User> getProjectUsers(String project, Role role,
			boolean includeInactive) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public void addUserToProject(final String user, String project,
			final Role asRole) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
		Map<String,String> postParams = new LinkedHashMap<>();
		if (user != null)
	...
	public List<ProjectUserAccessRule> getProjectUserAccessGrantees(
			String project, String subject) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public List<ProjectUserAccessRule> getProjectUserAccessSubjects(
			String project, String grantee) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public void deleteProjectUserAccess(String project, String grantee,
			String subject) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
	 ...
	 * {@link DetoxClientException DetoxClientException} with 403 Forbidden.</p>
	 *
	...
	public <T extends DatabaseObject> List<T> getRecords(String project,
			...
			ZonedDateTime end, Class<T> dataClass) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public <T extends DatabaseObject> List<T> getRecords(String project,
			...
			Class<T> dataClass) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
		return doGetRecords(project, table, subject, start, end, null, null, 0,
				dataClass);
	}
	...
	public <T extends DatabaseObject> List<T> getRecords(String project,
			...
			int limit, Class<T> dataClass) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public <T extends DatabaseObject> List<T> getRecords(String project,
			...
			Class<T> dataClass) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		return doGetRecords(project, table, subject, start, end, criteria, sort,
				limit, dataClass);
	}
	...
	private <T extends DatabaseObject> List<T> doGetRecords(String project,
			...
			final Class<T> dataClass) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		String path, method;
	...
	public <T extends DatabaseObject> T getFirstRecord(String project,
			String table, String subject, LocalDateTime start,
			LocalDateTime end, Class<T> dataClass) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		return doGetFirstLastRecord(project, table, subject, start, end, null,
				null, dataClass, true);
	}
	...
	public <T extends DatabaseObject> T getFirstRecord(String project,
			String table, String subject, DatabaseCriteria criteria,
			DatabaseSort[] sort, Class<T> dataClass) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	private <T extends DatabaseObject> T doGetFirstLastRecord(String project,
			...
			boolean isFirst) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
		String path, method;
	 ...
	 * subject, this method will throw an {@link DetoxClientException
	 * DetoxClientException} with 403 Forbidden. If the record ID doesn't
	 * exist, this method will throw an {@link DetoxClientException
	 * DetoxClientException} with 404 Not Found.</p>
	 * 
	 * @param project the project code
	 * @param table the table name
	 * @param subject the user ID of the subject user or null
	 ...
	 * the subject, this method will throw an {@link DetoxClientException
	 * DetoxClientException} with 403 Forbidden.</p>
	 * 
	 * @param project the project code
	 * @param table the table name
	 * @param subject the user ID of the subject user or null
	...
	public void writeRecord(String project, String table, String subject,
			DatabaseObject record) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 * DetoxClientException DetoxClientException} with 403 Forbidden. If
	 * the record ID doesn't exist, this method will throw a {@link
	 * DetoxClientException DetoxClientException} with 404 Not Found.
	 * 
	 * @param project the project code
	 * @param table the table name
	...
	public void updateRecord(String project, String table,
			final DatabaseObject record) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 */
	public void deleteRecords(String project, String table, String subject,
			ZonedDateTime start, ZonedDateTime end) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	 ...
	 */
	public void deleteRecords(String project, String table, String subject,
			LocalDate start, LocalDate end) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		doDeleteRecords(project, table, subject, start, end, null);
	}
	 ...
	 */
	public void deleteRecords(String project, String table, String subject,
			DatabaseCriteria criteria) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	private void doDeleteRecords(String project, String table,
			...
			final DatabaseCriteria criteria) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		String path, method;
		if (criteria == null) {
			path = String.format("/project/%s/table/%s", project, table);
	 ...
	 * DetoxClientException DetoxClientException} with 403 Forbidden. You may set
	...
	public void deleteRecord(String project, String table, final String subject,
			String id) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
	...
	public SyncResult syncRead(String project, int batchSize, Database db,
			...
			SyncProgressListener listener) throws DetoxClientException,
			HttpClientException, ParseException, IOException,
			DatabaseException {
		if (subject == null)
	...
	private SyncActionStats getSyncReadStats(String project, Database db,
			...
			boolean includeOwn) throws DetoxClientException, HttpClientException,
	...
	public void syncRegisterPush(String project, final String subject,
			...
			final String fcmToken) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public void syncUnregisterPush(String project, final String subject,
			final String deviceId) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public SyncResult syncWrite(String project, int batchSize, Database db,
			...
			final SyncProgressListener listener) throws DetoxClientException,
			HttpClientException, ParseException, IOException,
			DatabaseException {
		if (subject == null)
			throw new NullPointerException("Parameter \"subject\" is null");
	...
	private int syncWriteBatch(String project, int maxCount,
			SyncActionStats syncStats, Database db, final String subject,
			SyncTableRestriction tableRestriction) throws DetoxClientException,
	 ...
	 * nl.detoxathome.remotecaremanager.client.model.SystemStat.Name SystemStat.Name}.
	 * 
	 ...
	 * described at {@link nl.detoxathome.remotecaremanager.client.model.SystemStat.Name
	 * SystemStat.Name}.
	 * 
	 * <p>Note that a statistic may have multiple instances at one time. For
	 * example the file store space statistics have one value for each file
	...
	public void addUserEmailRegexAccess(String project, String subject,
			String emailRegex) throws DetoxClientException, HttpClientException,
			ParseException, IOException {
		String url = String.format("/project/%s/user_access", project);
	 ...
	 * will throw a {@link DetoxClientException DetoxClientException}
	 * with 403 Forbidden.
	 *
	 * @param subject the user ID of the subject user or null
	...
	public void addPermission(String subject, String permission,
			Map<String,Object> params) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	public void registerMobileWake(String subject, String deviceId,
			String fcmToken, int interval) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		Map<String,String> postParams = new LinkedHashMap<>();
		if (subject != null)
	 ...
	 * server
	 */
	private List<AuthHeader> getAuthHeaders() throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		if (authHeaders != null) {
			return authHeaders;
		} else {
			throw new DetoxClientException(401, "Unauthorized",
	...
	/**
	 * Runs a Detox query. If the query requires authentication, you should
	 ...
	 * #runQuery(String, String, boolean, DetoxRequestRunner, DetoxResultReader)
	...
	public void runQuery(String action, String method, boolean authenticate,
			HttpClientRunner runner) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
		HttpClient2 client = getHttpClient(action, method, authenticate);
		try {
			runner.run(client);
	...
	/**
	 * Creates an HTTP client for a new Detox query. This method is used in
	 * {@link #runQuery(String, String, boolean, DetoxRequestRunner, DetoxResultReader)
	...
	private HttpClient2 getHttpClient(String action, String method,
			boolean authenticate) throws DetoxClientException,
			HttpClientException, ParseException, IOException {
	...
	/**
	 * Creates an HTTP client for a new Detox query. In contrast to {@link
	 * #getHttpClient(String, String, boolean) getHttpClient()}, this method
	 * takes a complete URL, so it can also be used for Detox project
	 * services (see {@link DetoxProjectClient DetoxProjectClient}).
