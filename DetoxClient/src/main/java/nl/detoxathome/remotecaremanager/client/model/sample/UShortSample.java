...
/**
 * Sample with an unsigned short value (0..65535).
 * 
 * @author Dennis Hofs (RRD)
 */
public class UShortSample extends NumericSample<Integer> {
	 ...
	 * @param value the sample value (0..65535)
	 */
	public UShortSample(String user, ZonedDateTime tzTime, int value) {
		super(user, tzTime);
		this.value = value;
	}
