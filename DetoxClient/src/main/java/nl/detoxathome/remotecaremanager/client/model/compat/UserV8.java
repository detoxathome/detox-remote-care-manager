...
public class UserV8 extends BaseDatabaseObject {
	...
	public void copyFrom(DatabaseObject other) {
		if (!(other instanceof UserV8)) {
			super.copyFrom(other);
			return;
		}
		UserV8 otherUser = (UserV8)other;
		id = otherUser.id;
	...
	/**
	 * Converts a User object to a UserV8 object.
	 *
	 * @param user the User object
	 * @return the UserV8 object
	 */
	public static UserV8 fromUser(User user) {
		UserV8 result = new UserV8();
