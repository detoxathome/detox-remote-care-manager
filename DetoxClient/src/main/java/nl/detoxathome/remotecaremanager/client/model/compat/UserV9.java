...
import nl.detoxathome.remotecaremanager.client.model.MaritalStatus;
...
/**
 * Model of a user in Detox. This class is used on the client side. The
 ...
 */
public class UserV9 extends BaseDatabaseObject {
	@JsonIgnore
	private String id;
	...
	public void copyFrom(DatabaseObject other) {
		if (!(other instanceof UserV9)) {
			super.copyFrom(other);
			return;
		}
		UserV9 otherUser = (UserV9)other;
		id = otherUser.id;
	...
	/**
	 * Converts a User object to a UserV9 object.
	 *
	 * @param user the User object
	 * @return the UserV9 object
	 */
	public static UserV9 fromUser(User user) {
		UserV9 result = new UserV9();
