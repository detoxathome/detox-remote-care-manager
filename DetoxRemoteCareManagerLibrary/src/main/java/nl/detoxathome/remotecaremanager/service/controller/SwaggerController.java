...
public class SwaggerController {
	...
	public RedirectView redirectRoot() {
		return new RedirectView(RemoteCareManagerContext.getBaseUrl() + "/swagger-ui.html");
	}

	@Bean
	public OpenAPI api() {
		String url = RemoteCareManagerContext.getBaseUrl() + "/v" +
				RemoteCareManagerContext.getCurrentVersion();
		return new OpenAPI()
