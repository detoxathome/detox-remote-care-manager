...
public class EmailChangedNewVerifiedTemplateCollection extends EmailTemplateCollection {
	private Map<String,EmailTemplate> templateMap;

	public EmailChangedNewVerifiedTemplateCollection() {
	...
	private static class DefaultEmailChangedNewTemplate
			extends RemoteCareManagerEmailTemplate {
		@Override
		...
		protected String getHtmlMailContent(HttpServletRequest request,
			...
			String html = readHtmlContent(request, user,
					"mail_templates/email_changed_new_verified_mail");
