...
import nl.detoxathome.remotecaremanager.client.model.PushMessageData;
...
import nl.detoxathome.remotecaremanager.service.model.SyncPushRegistration;
import nl.detoxathome.remotecaremanager.service.model.SyncPushRegistrationTable;
...
public class PushNotificationService {
	...
	public void onAddDatabaseActions(String project, String database,
		...
		for (DatabaseAction action : actions) {
			...
			excludeSources.add(DetoxClient.SYNC_REMOTE_ID);
			if (isUserTable)
