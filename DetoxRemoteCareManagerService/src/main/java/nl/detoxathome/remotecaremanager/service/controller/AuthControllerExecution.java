...
import nl.detoxathome.remotecaremanager.client.model.compat.LoginUsernameResultV0;
...
import nl.detoxathome.remotecaremanager.service.controller.model.ChangePasswordParams;
import nl.detoxathome.remotecaremanager.service.controller.model.ResetPasswordParams;
import nl.detoxathome.remotecaremanager.service.exception.*;
...
public class AuthControllerExecution {
	...
	public void clearAuthTokenCookie(HttpServletResponse response) {
		...
		RemoteCareManagerCookie.clearAuthTokenCookie(baseUrl, response);
	}
